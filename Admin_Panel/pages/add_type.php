...
<!-- Select City Details -->
 ...
 <?php
   ...
   {  
      ...
      $type_added_on = $_POST['type_added_on'];
      $added_by      = $user_name;

      $sql = "INSERT INTO tb_type(city_id,city_name,type_name,type_added_on,added_by,entry_time)values('$city_id','$city_name','$type_name','$type_added_on','$added_by','$current_datetime')";
      ...
      $insert_row = $db->insert($sql);
        ...
        if($insert_row)
        {
          ...
          <script type="text/javascript">
            ...
            window.location='add_type.php?city_id=<?php echo $city_id; ?>&city_name=<?php echo $city_name; ?>';
          </script>
        <?php
        }
        else 
  ...
  <!-- Type List Table Data Load -->
 <?php
   $user_name = $_SESSION['user_name'];
   $db        = new Database();
   $sql       = "SELECT * FROM tb_type WHERE added_by = '$user_name'";
...
<head>
  ...
  <title>SMART CITY - Add Type</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="city_list_type.php" class="nav-link active">
                ...
                <div class="card-body">
                  ...
                  <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="type_name" name="type_name" placeholder="Enter Type Name" required>
                    </div>

                    <div class="form-group">
                      <label for="type_added_on">Type Added On *</label>
                      <input type="date" class="form-control" id="type_added_on" name="type_added_on" required>
                    </div>
                                                            
                    <div class="form-group">
                      <input type="submit" class="btn btn-primary btn-sm waves-effect waves-light" name="submit" value="Add Type">
                    </div>
                  </form>
                ...
                <div class="card-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="text-primary"><?php echo '[TI-0'.$result['type_id'].']'; ?></td>
                        <td><?php echo $result['type_name']; ?></td>
                        <td><?php echo date("F j, Y", strtotime($result['type_added_on'])) ?></td>
                        <td><?php echo $result['city_name']; ?></td>
                        <td>
                          <a href="update_type_details.php?type_id=<?php echo $result['type_id']; ?>&city_id=<?php echo $city_id; ?>&city_name=<?php echo $city_name; ?>" title="update" class="btn btn-info btn-sm waves-effect waves-light"><i class="fa fa-pencil"></i></a> | <a href="delete_data.php?type_id=<?php echo $result['type_id']; ?>&city_id_type=<?php echo $city_id; ?>&city_name_type=<?php echo $city_name; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm btn-round waves-effect waves-light"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
                      <?php } ?>
                      <?php }else{ ?>
