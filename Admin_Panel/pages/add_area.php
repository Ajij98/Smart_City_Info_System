...
<!-- Select City Details -->
 ...
 <?php
   ...
   {  
      ...
      $sql = "INSERT INTO tb_area(city_id,city_name,area_name,area_added_on,added_by,entry_time)values('$city_id','$city_name','$area_name','$area_added_on','$added_by','$current_datetime')";
      ...
      $insert_row = $db->insert($sql);
        ...
        if($insert_row)
        {
          ...
          <script type="text/javascript">
            window.alert("Area details added successfully.");
 ...
 <?php
   $user_name = $_SESSION['user_name'];
   $db        = new Database();
   $sql       = "SELECT * FROM tb_area WHERE added_by = '$user_name'";
...
<head>
  ...
  <title>SMART CITY - Add Area</title>
                ...
                <div class="card-body">
                  ...
                  <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="area_added_on" name="area_added_on" required>
                    </div>
                                                            
                    <div class="form-group">
                      <input type="submit" class="btn btn-primary btn-sm waves-effect waves-light" name="submit" value="Add Area">
                    </div>
                  </form>
                ...
                <div class="card-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="text-primary"><?php echo '[AI-0'.$result['area_id'].']'; ?></td>
                        <td><?php echo $result['area_name']; ?></td>
                        <td><?php echo date("F j, Y", strtotime($result['area_added_on'])) ?></td>
                        <td><?php echo $result['city_name']; ?></td>
                        <td>
                          <a href="update_area_details.php?area_id=<?php echo $result['area_id']; ?>&city_id=<?php echo $city_id; ?>&city_name=<?php echo $city_name; ?>" title="update" class="btn btn-info btn-sm waves-effect waves-light"><i class="fa fa-pencil"></i></a> | <a href="delete_data.php?area_id=<?php echo $result['area_id']; ?>&city_id_area=<?php echo $city_id; ?>&city_name_area=<?php echo $city_name; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm btn-round waves-effect waves-light"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
                      <?php } ?>
                      <?php }else{ ?>
