 ...
 <?php
   ...
   if(isset($_GET['city_id']))
   {
     ...
     while($getData = $result->fetch_assoc())
     {
         ...
         $city_added_on = $getData['city_added_on'];
     }
   }
  ?>
...
<!--Update City Details -->
  <?php
   ...
   if(isset($_POST['update']))
   {
        ...
        $sql = "UPDATE tb_city SET city_name='$city_name',city_added_on='$city_added_on' WHERE city_id = $city_id";
...
<head>
  ...
  <title>SMART CITY - Update City Details</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Update City Details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-primary col-lg-6">
              <div class="card-header">
                <h3 class="card-title">Update City Details</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                <div class="card-body">
                  ...
                  <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="city_name" name="city_name" placeholder="Enter City Name" value="<?php echo $city_name; ?>" required>
                    </div>

                    <div class="form-group">
                      <label for="city_added_on">City Added On *</label>
                      <input type="date" class="form-control" id="city_added_on" name="city_added_on" value="<?php echo $city_added_on; ?>" required>
                    </div>
