...
<head>
  ...
  <title>SMART CITY - Registered User</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="registered_user.php" class="nav-link active">
                ...
                <div class="card-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="text-primary"><?php echo '[UI-0'.$result['user_id'].']'; ?></td>
                        <td><?php echo $result['name']; ?></td>
                        <td><?php echo $result['phone']; ?></td>
                        <td><?php echo $result['address']; ?></td>
                        <td><?php echo date("F j, Y", strtotime($result['entry_time'])) ?></td></td>
                        <td>
                          <a href="delete_data.php?city_id=<?php echo $result['city_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm btn-round waves-effect waves-light"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
                      <?php } ?>
                      <?php }else{ ?>
