<?php
 ...
 <?php
   ...
   if(isset($_GET['type_id']))
   {
     ...
     $sql     = "SELECT * FROM tb_type WHERE type_id = $type_id AND city_name = '$city_name'";
     ...
     while($getData = $result->fetch_assoc())
     {
        ...
        $type_added_on = $getData['type_added_on'];
     }
   }
  ?>
...
<!--Update City Details -->
  <?php
   ...
   if(isset($_POST['update']))
   {
        ...
        $sql = "UPDATE tb_type SET city_name='$city_name',type_name='$type_name',type_added_on='$type_added_on' WHERE type_id = $type_id";
        ...
        $update_row = $db->update($sql);
         ...
         <script type="text/javascript">
           ...
           window.alert("Type updated successfully.");
...
<head>
  ...
  <title>SMART CITY - Update Type Details</title>
                ...
                <div class="card-body">
                  ...
                  <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="type_name" name="type_name" placeholder="Enter Type Name" value="<?php echo $type_name; ?>" required>
                    </div>

                    <div class="form-group">
                      <label for="type_added_on">Type Added On *</label>
                      <input type="date" class="form-control" id="type_added_on" name="type_added_on" value="<?php echo $type_added_on; ?>" required>
                    </div>
