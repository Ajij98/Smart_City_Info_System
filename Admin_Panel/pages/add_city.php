<?php
 ...
 <?php
   ...
   {  
      $city_code     = rand(100000, 999999);
      $city_name     = $_POST['city_name'];
      $city_added_on = $_POST['city_added_on'];
      $added_by      = $user_name;

      $sql = "INSERT INTO tb_city(city_code,city_name,city_added_on,added_by,entry_time)values('$city_code','$city_name','$city_added_on','$added_by','$current_datetime')";
      ...
      $insert_row = $db->insert($sql);
        ...
        if($insert_row)
        {
          ...
          <script type="text/javascript">
            window.alert("City details added successfully.");
  ...
  <!-- City List Table Data Load -->
 <?php
   $user_name = $_SESSION['user_name'];
   $db        = new Database();
   $sql       = "SELECT * FROM tb_city WHERE added_by = '$user_name'";
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="add_city.php" class="nav-link active">
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group">
                      <label for="city_added_on">City Added On *</label>
                      <input type="date" class="form-control" id="city_added_on" name="city_added_on" required>
                    </div>
                                                            
                    <div class="form-group">
                      <input type="submit" class="btn btn-primary btn-sm waves-effect waves-light" name="submit" value="Add City">
                    </div>
                  </form>
                ...
                <div class="card-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="text-primary"><?php echo '[CI-0'.$result['city_id'].']'; ?></td>
                        <td><?php echo $result['city_name']; ?></td>
                        <td><?php echo date("F j, Y", strtotime($result['city_added_on'])) ?></td>
                        <td>
                          <a href="update_city_details.php?city_id=<?php echo $result['city_id']; ?>" title="update" class="btn btn-info btn-sm waves-effect waves-light"><i class="fa fa-pencil"></i></a> | <a href="delete_data.php?city_id=<?php echo $result['city_id']; ?>" title="delete" onclick="return confirm('Sure to delete?')" class="btn btn-danger btn-sm btn-round waves-effect waves-light"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
                      <?php } ?>
                      <?php }else{ ?>
