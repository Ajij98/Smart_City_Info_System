...
<!-- Select Types Details -->
 <?php
   ...
   if(isset($_GET['city_id']))
   {
     ...
     $sql = "SELECT * FROM tb_place WHERE city_id = $city_id AND city_name = '$city_name' AND type_name = '$type_name'";

     $read_type_details = $db->select($sql);
   }
  ?>
...
<head>
  ...
  <title>SMART CITY - All Places</title>
  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <h2><?php echo $type_name; ?> - <?php echo $city_name; ?></h2>
    ...
    <div id="cities" class="col-10 m-auto">
      <div class="input-group mb-3">
        <strong style="margin-right: 10px; margin-top: 3px; font-size: 14px;">SEARCH BANK: </strong>
    ...
    <section id="featured" class="featured">
      <div class="container">
        ...
        <div class="row" id="search_category">
          ...
          <?php if($read_type_details){ $i = 0; ?>
          <?php while($result = $read_type_details->fetch_assoc()){ $i = $i + 1; ?>
          <div class="col-lg-4 col-md-6 col-sm-12" id="category">
            <a href="place_details.php?city_id=<?php echo $result['city_id']; ?>&city_name=<?php echo $result['city_name']; ?>&type=<?php echo $result['type_name']; ?>&place_name=<?php echo $result['place_name']; ?>&area_name=<?php echo $result['area_name']; ?>">
              <div class="card card-body shadow-sm mb-3">
                <div class="row">
                  <div class="col-6">
                    <p class="pb-0 my-2"><?php echo $result['place_name']; ?></p>
                  </div>
                  <div class="col-6">
                    <p class="pb-0 my-2"><img class="my-0 py-0" src="<?php echo '../Admin_Panel/pages/'.$result['place_img']; ?>" height="80" style="border-radius: 5px;"></p>
                  </div>
                </div>
                <p class="my-0 py-0 align-right" style="font-size: 13px;"><i class="fa fa-map-marker"></i> <?php echo $result['area_name']; ?></p>
              </div>
            </a>
          </div>
          <?php } ?>
